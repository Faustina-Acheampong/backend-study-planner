    ...
    <div className="container">
     <h1 className=" text-gray-900  transition my-4 text-center text-2xl  font-bold font-sans"> Menu</h1>
      ...
      <div className="text-centerp-6 bg-purple-100 hover:bg-purple-200 rounded-xl shadow-lg  flex-row">
        <h1 className="w-full py-2 px-4 block bg-purple-100 hover:bg-purple-200 rounded-lg text-gray-900 font-semibold transition my-4 text-center font-sans"> Date and Time</h1>
        <p className="w-full py-2 px-4 block bg-purple-100 hover:bg-purple-200 rounded-lg text-gray-900 font-semibold transition my-4 text-center font-sans">{currentDateTime}</p>
      </div>
    </div>
      <TimeWidget />
      <TasksWidget />
